...
main1(int argc, char **argv)
{
   ...
   */
  /*Modification Begin*/
  srcinfo = malloc(sizeof(struct jpeg_decompress_struct));
  dropinfo = malloc(sizeof(struct jpeg_decompress_struct));
  jdroperr = malloc(sizeof(struct jpeg_error_mgr));
  dstinfo = malloc(sizeof(struct jpeg_compress_struct));
  jsrcerr = malloc(sizeof(struct jpeg_error_mgr));
  jdsterr = malloc(sizeof(struct jpeg_error_mgr));
  src_progress = malloc(sizeof(struct cdjpeg_progress_mgr));
  dst_progress = malloc(sizeof(struct cdjpeg_progress_mgr));
  transformoption = malloc(sizeof(jpeg_transform_info));
  /*Modification End*/
  FILE *fp;
  FILE *icc_file;
  ...
  // {
  //   mutate_jpeg_decompress_struct(srcinfo, 0);
  //   exit(0);
  // }
  ...
  if(setjmp(memfuzz_jmp_buf) == 0)
  {
    mutate_jpeg_compress_struct(dstinfo, 0);
    exit(0);
  }
  /*Modification End*/
...
int main(int argc, char** argv)
{
  // if(argc != 2)
  // {
  //   printf("./jpegtran input\n");
  //   return 1;
  // }
  int argc1 = 6;
  char **argv1 = NULL;
  argv1 = malloc(sizeof(char*) * 7);
  argv1[0] = argv[0];
  argv1[1] = "-copy";
  argv1[2] = "all";
  argv1[3] = "-outfile";
  argv1[4] = MEMFUZZ_OUTFILE;//change to MEMFUZZ_OUTFILE
  argv1[5] = MEMFUZZ_INFILE; //argv[1]
  argv1[6] = NULL;
  alloc_init();
  memfuzz_init();
  main1(argc1, argv1);
