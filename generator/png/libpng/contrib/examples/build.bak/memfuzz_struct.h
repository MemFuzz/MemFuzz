...
struct memfuzz_anonymous_struct_20;
struct memfuzz_anonymous_struct_21;
...
struct memfuzz_anonymous_struct_15;
struct memfuzz_anonymous_struct_14;
struct memfuzz_anonymous_struct_17;
struct memfuzz_anonymous_struct_16;
...
/* Used at: pngwutil.c */
/* <3156> /home/youwei/MemFuzz/Product/libpng/master/src_raw/pngwutil.c:469 */
typedef struct memfuzz_anonymous_struct_22 {
	const unsigned char        *input;               /*     0     8 */
...
/* Used at: pngwrite.c */
/* <2a7a> /home/youwei/MemFuzz/Product/libpng/master/src_raw/pngwrite.c:1500 */
typedef struct memfuzz_anonymous_struct_19 {
	...
	const const void           *buffer;              /*     8     8 */
	int                        row_stride;           /*    16     4 */

	/* XXX 4 bytes hole, try to pack */

	const const void           *colormap;            /*    24     8 */
	int                        convert_to_8bit;      /*    32     4 */

	/* XXX 4 bytes hole, try to pack */

	const const void           *first_row;           /*    40     8 */
...
/* Used at: pngread.c */
/* <34e7> /home/youwei/MemFuzz/Product/libpng/master/src_raw/pngread.c:1283 */
typedef struct memfuzz_anonymous_struct_10 {
	...
	void *                     colormap;             /*    24     8 */
	const struct png_color_struct *background;       /*    32     8 */
	void *                     local_row;            /*    40     8 */
	void *                     first_row;            /*    48     8 */
...
/* Used at: png.c */
/* <33d> /home/youwei/MemFuzz/Product/libpng/master/src_raw/png.c:2245 */
struct memfuzz_anonymous_struct_0 {
...
/* Used at: png.c */
/* <2291> ./pngstruct.h:143 */
struct png_struct_def {
	long unsigned int       jmp_buf_local[25];     /*     0   200 */
	...
	long unsigned int          zstream[14];              /*   320   112 */
	...
	unsigned int               mng_features_permitted; /*   984     4 */
	unsigned char              filter_type;          /*   988     1 */

	/* XXX 3 bytes hole, try to pack */

	void *                     mem_ptr;              /*   992     8 */
	void **malloc_fn;                                                /*  1000     8 */
	void **free_fn;                                                /*  1008     8 */
	unsigned char              *big_row_buf;         /*  1016     8 */
	/* --- cacheline 16 boundary (1024 bytes) --- */
	unsigned char              *quantize_sort;       /*  1024     8 */
	unsigned char              *index_to_palette;    /*  1032     8 */
	unsigned char              *palette_to_index;    /*  1040     8 */
	unsigned char              compression_type;     /*  1048     1 */

	/* XXX 3 bytes hole, try to pack */

	unsigned int               user_width_max;       /*  1052     4 */
	unsigned int               user_height_max;      /*  1056     4 */
	unsigned int               user_chunk_cache_max; /*  1060     4 */
	long unsigned int          user_chunk_malloc_max; /*  1064     8 */
	struct png_unknown_chunk_t unknown_chunk;        /*  1072    32 */
	/* --- cacheline 17 boundary (1088 bytes) was 16 bytes ago --- */
	long unsigned int          old_big_row_buf_size; /*  1104     8 */
	unsigned char              *read_buffer;         /*  1112     8 */
	long unsigned int          read_buffer_size;     /*  1120     8 */
	unsigned int               IDAT_read_size;       /*  1128     4 */
	unsigned int               io_state;             /*  1132     4 */
	unsigned char              *big_prev_row;        /*  1136     8 */
	void **read_filter[4];                                             /*  1144    32 */
	/* --- cacheline 18 boundary (1152 bytes) was 24 bytes ago --- */
	struct png_colorspace      colorspace;           /*  1176    76 */

	/* size: 1256, cachelines: 20, members: 145 */
	/* sum members: 1213, holes: 12, sum holes: 39 */
	/* padding: 4 */
	/* last cacheline: 40 bytes */
};
/* Used at: png.c */
...
/* Used at: pngrtran.c */
/* <a9> /home/youwei/MemFuzz/Product/libpng/master/src_raw/pngrtran.c:418 */
struct png_dsort_struct {
...
struct png_control {
	...
	void *                     error_buf;            /*    16     8 */
	const unsigned char        *memory;              /*    24     8 */
