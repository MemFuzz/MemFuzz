...
# Import target "generator" for configuration ""
set_property(TARGET generator APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)
set_target_properties(generator PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/bin/generator"
  )

list(APPEND _cmake_import_check_targets generator )
list(APPEND _cmake_import_check_files_for_generator "${_IMPORT_PREFIX}/bin/generator" )
