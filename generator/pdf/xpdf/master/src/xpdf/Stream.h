...
public:
  ...
  /*Modification Begin*/
  virtual Stream *dup(){return NULL;};

  virtual char* get_content(int *len){*len = 0; return NULL;};
  /*Modification End*/
...
public:
  ...
  /*Modification Begin*/
  virtual Stream *dup(){return str->dup();};

  virtual char* get_content(int *len){return str->get_content(len);};
  /*Modification End*/
...
public:
  ...
  /*Modification Begin*/
  virtual Stream* dup();
  virtual char* get_content(int *len){*len = this->len; return this->content;};
  /*Modification End*/
private:
  ...
  /*Modification Begin*/
  FileStream(SharedFile *fA, GFileOffset startA, GBool limitedA,
	     GFileOffset lengthA, Object *dictA, char* contentA, int lenA);
  /*Modification End*/
  GBool fillBuf();
...
/*Modification Begin*/
class DupStream: public BaseStream
{
public:
    //Some virtual function, do nothing
    virtual Stream* copy(){return this->dup();};
    virtual StreamKind getKind(){return strDup;};
    virtual void reset() {};
    virtual int getChar() {return EOF;};
    virtual int lookChar() {return EOF;};
    virtual GFileOffset getPos() {return 0;};
    virtual void setPos(GFileOffset pos, int dir = 0) {};
    virtual Stream *makeSubStream(GFileOffset start, GBool limitedA,
				GFileOffset lengthA, Object *dictA) {return NULL;};
    virtual GFileOffset getStart() {return 0;};
    virtual void moveStart(int delta){};
    //New function
    DupStream(Object* dictA, int lenA, char* contentA);
    ~DupStream();
    virtual Stream* dup();
    virtual char* get_content(int* lenA);
private:
    int len;
    char* content;
};
